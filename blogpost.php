...
<body>
    <nav class="navigation max-width-1 m-auto">
        <div class="nav-left">
            ...
            <ul>
                <li><a href="/Task-01/index.php">Home</a></li>
                <li><a href="#">About</a></li>
                <li><a href="/Task-01/contact.php">Contact</a></li>
            </ul>
        </div>
        <div class="nav-right">
    ...
    <div class="m-auto blog-post-content max-width-2 m-auto my-2">
        ...
        <div class="blogpost-meta">
            ...
            <div class="social">
                <a href="https://github.com/Tdchaudhari1501" target="_blank">
                    <img style="background: black;
                    border-radius: 21px;" width="40" height="32" viewBox="0 0 29 29" fill="none" class="hk" src="img/th.jpg" alt="">
                </a>

                <a href="https://www.linkedin.com/in/tushar-chaudhari-284ab128a" target="_blank">
